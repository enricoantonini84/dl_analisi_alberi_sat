...
% --- Title and meta ---
\title{\textbf{Analisi tree-cover tramite immagini satellitari}}
...
\fancyfoot[L]{\footnotesize\parbox{1.0\textwidth}{%
    Studio e utilizzo di tecniche di deep learning per la rilevazione\\
    automatica della copertura arborea da immagini satellitari}}
\fancyfoot[R]{\thepage}
